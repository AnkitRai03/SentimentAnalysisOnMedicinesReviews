...
def tell_medicine() :
  ...
  abc = [string.lower() for string in abc]
  ...
  updated_data2.loc[:,'updated_reviews'] = pd.Series(updated_reviews, index=updated_data2.index)
  ...
  # checking the result
  # convert df/series into array like structure
  ...
  for medicine,values in medicines_reviews_with_usefulcount.items() :
    ...
    for review in values :
      ...
      if overall_per_reviewscore >= 2.50 :
  ...
  # sort on the basis of rating value of medicines
